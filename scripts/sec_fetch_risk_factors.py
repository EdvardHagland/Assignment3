...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default="data",
        help="Directory for extracted sections and chunks.",
    )
    parser.add_argument(
        "--start-year",
        type=int,
...
def main() -> int:
    ...
    write_csv(
        output_dir / "processed" / "risk_sections.csv",
        section_rows,
        [
            "filing_id",
            "ticker",
    ...
    write_csv(
        output_dir / "processed" / "risk_paragraphs.csv",
        paragraph_rows,
        [
            "paragraph_id",
            "filing_id",
    ...
    write_csv(
        output_dir / "processed" / "risk_chunks.csv",
        paragraph_rows,
        [
            "paragraph_id",
            "filing_id",
