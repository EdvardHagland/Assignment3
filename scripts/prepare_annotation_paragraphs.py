...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        default="data/full_2018_paragraphs/processed/risk_paragraphs.csv",
        help="Path to the raw paragraph CSV from sec_fetch_risk_factors.py",
    )
    parser.add_argument(
        "--output",
        default="data/full_2018_paragraphs/processed/annotation_ready_paragraphs.csv",
        help="Output CSV path for cleaned annotation rows.",
    )
    parser.add_argument(
        "--report",
        default="data/full_2018_paragraphs/processed/annotation_cleaning_report.csv",
